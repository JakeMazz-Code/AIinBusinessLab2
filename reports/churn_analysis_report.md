...
## 6. Visual Insights
![Plan Churn Rate](figures/plan_churn_rate.png)
...
![Monthly Spend By Churn](figures/monthly_spend_by_churn.png)

![Support Tickets By Churn](figures/support_tickets_by_churn.png)

![Logistic Probability Distribution](figures/logistic_probability_distribution.png)

![Tenure Vs Last Login Scatter](figures/tenure_vs_last_login_scatter.png)

![Numeric Pairplot](figures/numeric_pairplot.png)
